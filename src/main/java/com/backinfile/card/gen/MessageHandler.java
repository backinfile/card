...
public class MessageHandler extends DSyncBaseHandler {
	...
	public static class DBoard extends DSyncBase {
		...
		public static DBoard newInstance(MessageHandler _handler) {
			if (_handler.mode == Mode.Client) {
				throw new DSyncException("Client模式下，不能创建DSync数据对象");
			}
	...
	public static class DCardPile extends DSyncBase {
		...
		public static DCardPile newInstance(MessageHandler _handler) {
			if (_handler.mode == Mode.Client) {
				throw new DSyncException("Client模式下，不能创建DSync数据对象");
			}
	...
	public static class DHuman extends DSyncBase {
		...
		public static DHuman newInstance(MessageHandler _handler) {
			if (_handler.mode == Mode.Client) {
				throw new DSyncException("Client模式下，不能创建DSync数据对象");
			}
